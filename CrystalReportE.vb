...
Public Class CrystalReportE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Inventario_y_Facturación.CrystalReportE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportE = New CrystalReportE()
        rpt.Site = Me.Site
        Return rpt
    End Function
