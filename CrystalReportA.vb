...
Public Class CrystalReportA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Inventario_y_Facturación.CrystalReportA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportA = New CrystalReportA()
        rpt.Site = Me.Site
        Return rpt
    End Function
