...
Public Class CrystalReportP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_de_Inventario_y_Facturación.CrystalReportP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportP = New CrystalReportP()
        rpt.Site = Me.Site
        Return rpt
    End Function
